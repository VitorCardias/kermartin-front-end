...
import type { Cliente, ClientePessoaFisica } from "../../../hooks/useClientes";

type EditarClientePessoaFisicaModalProps = {
  cliente: ClientePessoaFisica;
  onClose: () => void;
  onUpdate: (clienteEditado: Cliente) => void;
};

const EditarClientePessoaFisicaModal: React.FC<EditarClientePessoaFisicaModalProps> = ({ cliente, onClose, onUpdate }) => {
  const [formData, setFormData] = useState<ClientePessoaFisica>(
    { 
      ...cliente,
    }
  );
...
export default EditarClientePessoaFisicaModal;