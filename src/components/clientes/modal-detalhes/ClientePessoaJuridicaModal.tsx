import type { ClientePessoaJuridica } from "../../../hooks/useClientes";
import { formatarDisplayTipoCliente } from "../../../types/TiposClientes";

type ClientePessoaJuridicaModalProps = {
  cliente: ClientePessoaJuridica | null;
  onClose: () => void
}

const ClientePessoaJuridicaModal: React.FC<ClientePessoaJuridicaModalProps> = ({ cliente, onClose }) => {
  ...
  return (
    ...
    <div className="fixed inset-0 flex items-center justify-center">
      <div className="w-full max-w-lg bg-white p-6 rounded-md border border-gray-300 shadow-2xl text-left">
        ...
        <div className="text-lg"><strong>CNPJ:</strong> {cliente.cnpj || 'Não consta.'}</div>
...
export default ClientePessoaJuridicaModal;