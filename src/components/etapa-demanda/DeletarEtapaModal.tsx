...
const DeletarEtapaModal: React.FC<DeletarEtapaModalProps> = ({ etapa, onClose, deletar }) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center p-6">
      <div className="w-full max-w-md sm:max-w-lg md:max-w-xl bg-white p-6 rounded-md border border-gray-300 shadow-2xl max-h-screen overflow-y-auto">
        <div className="flex justify-between items-center mb-4"> {/* Adicionei flex, justify-between e items-center */}
          <h3 className="text-2xl font-semibold">Excluir Etapa</h3>
        </div>

        <hr className="border-t border-gray-200 my-4" />

        <div>
          <p> Você tem certeza que deseja excluir esta Etapa? </p>
          <p> Etapa de título: {etapa.titulo} </p>
        </div>
...
export default DeletarEtapaModal;
